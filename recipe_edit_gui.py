...
def recipe_edit_gui(a_list, selected_items):
    ### Load data
    all_recipes ={}
    for item in a_list:
    ...
    ### Configure
    app_title = "Recipe Editor"

    section_1_title="Select Recipe to Edit"
    section_2_title="Section 2"
    section_3_title="Section 3"

    button_name_edit_selected = "Edit Selected"
    ...
    button_name_create_new = "Create New"
    button_8 = "b8"
    ...
    ### Function defs
    def press(button):
        if button == button_name_edit_selected:
        ...
        elif button == button_name_create_new:
            print(button)
    ...
    app.stopScrollPane()
    app.addButtons([button_name_edit_selected, button_name_create_new], press, 2,0)
...
if __name__ == "__main__":
    ...
    selected = []
    recipe_edit_gui(all_recipes, selected)
    print(selected)
